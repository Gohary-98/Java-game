...
public abstract class Unit implements Simulatable, SOSResponder {
	...
	public void respond(Rescuable r) throws CannotTreatException, IncompatibleTargetException, CitizenAlreadyDeadException, BuildingAlreadyCollapsedException {
		...
		/*if (this instanceof MedicalUnit && r instanceof ResidentialBuilding || (this instanceof FireUnit|| this instanceof PoliceUnit) && r instanceof Citizen) {
	...
	public boolean canTreat(Rescuable r){
		if (r instanceof Citizen) {
			Citizen x = (Citizen)r;
			return x.getBloodLoss()==0 &&x.getToxicity()==0;
		}
		else {
			ResidentialBuilding x = (ResidentialBuilding) r ;
			return x.getFireDamage()==0 && x.getGasLevel()==0;
