...
public class DiseaseControlUnit extends MedicalUnit {
	...
	public void respond(Rescuable r) throws IncompatibleTargetException, CannotTreatException, CitizenAlreadyDeadException {
		if (r instanceof ResidentialBuilding) {
			throw new IncompatibleTargetException(this,r,"Disease Control Unit is incompatible with Building type");
		}
		else {
			Citizen x = (Citizen)r;
			if (x.getToxicity()==0) {
				throw new CannotTreatException(this, r,"Unit of type Disease Control Unit Cannot treat Citizen at "+r.getLocation());
			}
			if (x.getHp()==0)
